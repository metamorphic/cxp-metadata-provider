...
public class FileDataset {
    ...
    public List<FileColumn> getColumns() {
        if (columns == null) return Collections.<FileColumn>emptyList();
    ...
    public List<FileColumn> getNaturalKeyColumns() {
        if (naturalKeyColumns == null) return Collections.<FileColumn>emptyList();
        List<FileColumn> ret = new ArrayList<>(naturalKeyColumns);
        Collections.sort(ret, new Comparator<FileColumn>() {
            @Override
            public int compare(FileColumn a, FileColumn b) {
                // ascending order
